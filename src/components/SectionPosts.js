        ...
        return (
            <section id={_.get(section, 'section_id', null)} className="posts">
                ...
                <div className="article-teaser">
                    {_.get(post, 'frontmatter.thumb_img_href', null) ? <a href={_.get(post, 'frontmatter.thumb_img_href', null)} className="logo">{post_thumb(post)}</a> : true }
                <Link key={post_idx} to={withPrefix(_.get(post, 'url', null))}>
                    {_.get(post, 'frontmatter.thumb_img_href', null) ? true : post_thumb(post)}
                    <div className="copy">
